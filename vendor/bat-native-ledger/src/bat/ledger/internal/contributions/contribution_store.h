...
class ContributionStore : public BATLedgerContext::Object {
 public:
  ...
  Future<bool> SetPublisherAutoContributeEnabled(
      const std::string& publisher_id,
      bool enabled);

  Future<bool> ResetPublisherAutoContributeEnabled();

  Future<bool> AddPublisherActivity(const std::string& publisher_id,
                                    int visit_count,
